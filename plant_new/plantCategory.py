...
class CategoryService:
    ...
    def search_by_property(self):
        ...
        subcategories = self.category_dao.get_subcategories_by_property(property_name, property_value)
    ...
    def search_by_growth_environment(self):
        ...
        if not matching_categories:
            ...
            for matching_category in matching_categories:
                print(
                    f"植物编号: {matching_category['植物编号']}, 植物名称: {matching_category['植物名称']}, 学名: {matching_category['学名']}, "
                    f"栽培技术要点: {matching_category['栽培技术要点']}, 应用价值: {matching_category['应用价值']}, 形态特征: {matching_category['形态特征']}")
    def manageMenu(self):
        while True:
            print("\n植物分类管理")
            print("1. 添加分类")
