...
class PlantDAO:
    ...
    def add_plant(self, plant):  # 增加
        sql = (f"INSERT INTO 植物基本信息 VALUES ('{plant.plant_id}', '{plant.plant_name}', "
               f"'{plant.scientific_name}', '{plant.cultivation_points}', '{plant.application_value}', "
               f"'{plant.morphological_features}')")
    ...
    def manage_menu(self):
        while True:
            ...
            if choice == "1":
                ...
                plantslist = self.plant_dao.get_all_plants()
                if plantslist:
                    for i in plantslist:
                        i.display_info()
